...
export function initializeEventListeners() {
    ...
    if (searchBtn && searchInput && mealList && mealDetailsContent && recipeCloseBtn && recipeDialog && dialogCloseBtn) {
...
function mealRecipeModal(meals) {
    ...
    `;
    const mealDetailsContent = document.querySelector('#recipe-dialog .meal-details-content');
    const recipeDialog = document.getElementById('recipe-dialog');
